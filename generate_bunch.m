...
Q = -1; % antiprotons
charge = 1e7;
gemitt_x = 0.5e-06; % Geometric emittance m
...
T = Bunch6d_twiss();
T.emitt_x = nemitt_x * 1e6; % mm.mrad == micron
T.emitt_y = nemitt_x * 1e6; % mm.mrad == micron
...
% Gaussian buch
save -ascii 'Results/initial_particles.dat' M
